...
MyTrackerAttributionListener? _attributionListener;
...
final class MyTracker {
  ...
  static final MyTrackerConfig trackerConfig = MyTrackerConfig();

  /// Returns the instance of MyTrackerParams
  static final MyTrackerParams trackerParams = MyTrackerParams();
